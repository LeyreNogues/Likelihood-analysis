...
//			std::cout << "It's signal" << std::endl;
	...
	std::cout << "Factor delay-alpha: " << QGfixedPart/PlanckScale << std::endl;
...
//	dist->SetLogx();
//	dist->SetLogy();
//	energyint->SetMarkerSize(0.8);
//	energyint->GetXaxis()->SetTitle("Energy(GeV)");
//	energyint->SetMarkerStyle(8);
//	energyint->Draw("P");
//	energyrec->SetMarkerColor(2);
//	energyrec->SetMarkerSize(0.8);
//	energyrec->SetMarkerStyle(8);
//	energyrec->Draw("Psame");
//	dist->cd(2);
//	timeint->Draw("");
...
//	leg1->AddEntry(energyint,"Intrinsic","p");
//	leg1->AddEntry(energyrec,"Smeared","p");
//	leg1->Draw();
...
//	//Create a txt file with the events
	FILE *fout;
	fout = fopen(Form("Manel_flare_resprueba_alpha%i.txt", (int)alpha),"wb");
	for(int i = 0; i<numberOfEvents; i++)
	{
