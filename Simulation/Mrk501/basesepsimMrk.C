...
void simulation(Int_t num)
{
	...
	FILE *fout;
	fout = fopen(Form("/home/lnogues/workspace_cpp/LIVanalysis/Simulation/Mrk501/New/tau-80/flarebase%i.txt", num),"wb");
	...
	TString rootoutfile(Form("/home/lnogues/workspace_cpp/LIVanalysis/Simulation/Mrk501/New/tau-80/Simulationbase%i.root", num));
...
void basesepsimMrk()
{
	...
	TCanvas* big = new TCanvas("tau-80base", "tau-80base", 1000, 1000);
	big->Divide(2,4);
	big->cd(1);
	...
	ratiohisto->Draw("EP");
	big->SaveAs("./New/tau-80/Canvastau-80base.png");
