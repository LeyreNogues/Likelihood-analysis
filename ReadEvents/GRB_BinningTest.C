 ...
 *  and allow to do cut, tranform MJD to second and create histograms adapted to the wobbles.
...
void GRB_BinningTest(char *fname)
{
...
//    		 energy->Fill(Ep[a],1/Ep[a]);
     ...
     Double_t binwidth=180.; // In seconds
     const Int_t numberOfWobbles = 5; //Number of wobbles
...
//		  cout << i << endl;
	  ...
	  Int_t counter = 0;
	  Int_t event_index = 0;
	  Int_t ON_events = 16;  //HERE YOU INDICATE THE NUMBER OF EVENTS PER BIN
	  ...
	  Int_t rest= 0;
	  for(Int_t a = 0; a<1; a=a+2){//numberOfIntervals
